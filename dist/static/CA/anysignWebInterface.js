 ...
 */
var base_url='static/CA/';

document.write("<link href=\""+base_url+"css/canvas_css.css\" rel=\"stylesheet\">");
document.write("<link href=\""+base_url+"css/sp.css\" rel=\"stylesheet\">");

document.write("<link media=\"screen and (max-width: 480px)\" href=\""+base_url+"css/mw480Portrait.css\" rel=\"stylesheet\">");
document.write("<link media=\"screen and (min-width: 480px) and (max-width: 1024px)\" href=\""+base_url+"css/mw480Portrait.css\" rel=\"stylesheet\">");
document.write("<link media=\"screen and (min-width: 1024px)\" href=\""+base_url+"css/sw1024.css\" rel=\"stylesheet\">");

document.write("<script language=javascript src=\""+base_url+"libs/zlib/deflate.min.js\" charset=\"utf-8\"></script>");

document.write("<script language=javascript src=\""+base_url+"libs/CryptoJS v3.1.2/components/core-min.js\" charset=\"utf-8\"></script>");
document.write("<script language=javascript src=\""+base_url+"libs/CryptoJS v3.1.2/rollups/sha1.js\" charset=\"utf-8\"></script>");
document.write("<script language=javascript src=\""+base_url+"libs/CryptoJS v3.1.2/rollups/tripledes.js\" charset=\"utf-8\"></script>");
document.write("<script language=javascript src=\""+base_url+"libs/CryptoJS v3.1.2/components/mode-ecb.js\" charset=\"utf-8\"></script>");

document.write("<script language=javascript src=\""+base_url+"libs/anysign_all.js\" charset=\"utf-8\"></script>");
...
//    }
	...
	{
		return "AnySign_V1.3.2_Web_2.1.0.29135";
	}
...
var SignRule_KeyWord = function(keyword, keyWordAlignMethod, keyWordOffset, pageNo)
{
    ...
    {
        this.KWRule = {KW:keyword, KWPos:keyWordAlignMethod, KWOffset:keyWordOffset, StartPage:pageNo};
    }
}
...
var SignRule_KeyWordV2 = function(keyword, keyWordAlignMethod, keyWordOffset, pageNo, KWIndex)
{
    ...
    {
        this.KWRule = {KW:keyword, KWPos:keyWordAlignMethod, KWOffset:keyWordOffset, StartPage:pageNo,KWIndex:KWIndex};
    }
}
...
var SignRule_KeyWordV3 = function(keyword, xOffset, yOffset, pageNo,  KWIndex){
    ...
    {
        this.KWRule = {KW:keyword, XOffset:xOffset, YOffset:yOffset, Pageno :pageNo,KWIndex:KWIndex};
    }
